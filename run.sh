...
if [ -z "$BOT_TOKEN" ]
then
echo "Discord integration bot token not set, token will be left blank"
fi
if [ -z "$BOT_CHANNEL" ] 
then
echo "Discord integration channel ID not set, channel will be left blank"
fi
